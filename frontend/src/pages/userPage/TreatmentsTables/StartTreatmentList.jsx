...
import { getCreatedProfilePatientsList, getPatients } from "../../../redux/actions/patientsAction";
import DataTable from "react-data-table-component";
import { Link, useNavigate } from "react-router-dom";

const StartTreatmentList = () => {
  ...
  const { createdProfilePatitentsList, createdProfilePatitentsCount, isloading } =
    useSelector((state) => state.startTreatmentProfiles);

  console.log("createdProfilePatitentsList:", createdProfilePatitentsList);
  console.log("createdProfilePatitentsCount:", createdProfilePatitentsCount);
  ...
  const patientsTableData = createdProfilePatitentsList?.map((item) => {
    return {
      _id: item._id,
        ...
        <div className="">
          <div className="container-fluid px-0 my-3  ">
            <DataTable
              ...
              paginationTotalRows={createdProfilePatitentsCount} // Total number of rows for pagination
...
export default StartTreatmentList;
